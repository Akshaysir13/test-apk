...
const navigate = useNavigate();
  ...
  const courses = [
    ...
    },
    {
      ...
      testimonial: { name: "Priya S.", text: "Best ₹99 I ever spent!" }
    },
    {
      id: 'foundation',
      ...
      testimonial: { name: "Rahul V.", text: "Scored 248/400, got into NIT Trichy!" }
    },
    {
      id: 'advance_2026',
      ...
      testimonial: { name: "Sneha M.", text: "Perfect for final month revision!" }
    },
  ];
  ...
  const faqs = [
    ...
    },
    {
      ...
      a: "Yes! 100% money-back guarantee within 7 days if you're not satisfied. No questions asked."
    },
    {
        ...
        <div className="max-w-7xl mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              <div className="w-10 h-10 bg-gradient-to-br from-blue-600 to-purple-600 rounded-lg flex items-center justify-center text-white font-bold text-xl">M</div>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex items-center justify-center gap-3 flex-wrap text-sm md:text-base">
            ...
            <div className="flex gap-2">
              <span className="bg-white/20 px-3 py-1 rounded font-bold">{String(timeLeft.hours).padStart(2, '0')}h</span>
              <span className="bg-white/20 px-3 py-1 rounded font-bold">{String(timeLeft.minutes).padStart(2, '0')}m</span>
              <span className="bg-white/20 px-3 py-1 rounded font-bold">{String(timeLeft.seconds).padStart(2, '0')}s</span>
            </div>
            <span className="font-semibold">67% OFF All Courses!</span>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-12 md:py-16">
        <div className="text-center">
          ...
          <p className="text-xl md:text-2xl text-gray-600 mb-8 max-w-3xl mx-auto">
            Practice with <strong>India's largest PYQ bank (2005-2025)</strong> designed by SPA & NIT experts
          </p>
      ...
      <div className="bg-gradient-to-r from-green-500 to-teal-600 py-6">
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex items-center justify-center gap-8 flex-wrap text-white">
            ...
            <div className="text-center">
              <p className="text-3xl font-bold">SPA/NIT</p>
        ...
        <div className="mt-12 text-center">
          <div className="inline-flex items-center gap-3 bg-green-50 border-2 border-green-200 px-6 py-4 rounded-xl">
            ...
            <div className="text-left">
              ...
              <p className="text-sm text-gray-600">Not satisfied? Get full refund within 7 days</p>
            </div>
          </div>
        </div>
      </div>
              ...
              <table className="w-full">
                ...
                <tbody>
                  {[
                    ...
                    { feature: 'PYQ Coverage', values: ['2023-2025', '2023-2025', '2005-2025 ✓', '2024-2025'] },
                    ...
                    { feature: 'Support', values: ['Community', 'Email', 'Priority 24/7 ✓', 'Email'] },
                    { feature: 'Study Material', values: ['❌', '❌', '✓ Included', '❌'] },
                    { feature: 'Doubt Resolution', values: ['❌', '❌', '✓ Included', 'Email'] }
                  ].map((row, idx) => (
          ...
          {[
            {
              ...
              course: "Foundation",
              image: "👨‍🎓",
              text: "Foundation course's 2005-2025 PYQ bank covered everything! The mock tests were exactly like the real exam. Highly recommend!",
              improvement: "+68 marks"
            },
            {
              name: "Priya Sharma",
              score: "245/400",
              ...
              course: "Foundation",
              image: "👩‍🎓",
              text: "Started with free tests, then got Rank Booster, finally Foundation. Best decision for my prep. The progression helped me improve consistently.",
              improvement: "+72 marks"
            },
            {
              name: "Sneha Patel",
              score: "252/400",
              ...
              course: "Foundation",
              image: "👩‍🎓",
              text: "The 99 percentile strategy guide was game-changing. Foundation course gave me everything I needed to crack JEE B.Arch with a top rank!",
              improvement: "+80 marks"
            }
          ].map((story, idx) => (
      ...
      <div className="bg-gradient-to-r from-purple-600 to-pink-600 py-16">
        <div className="max-w-4xl mx-auto px-4 text-center text-white">
          ...
          <p className="mt-6 text-sm">
            ⏰ Limited time: 67% OFF • 💯 7-day money-back guarantee
          </p>
        </div>
      </div>
