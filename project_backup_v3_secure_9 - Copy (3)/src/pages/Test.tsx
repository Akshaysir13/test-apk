...
export default function Test() {
  ...
  useEffect(() => {
    ...
    const preventShortcuts = (e: KeyboardEvent) => {
      ...
      // On desktop, block screenshot keyboard shortcuts.
      // On Android/mobile, let the OS handle screenshots normally.
      if (!isMobile && screenshotKeys.some(check => check())) {
        e.preventDefault();
        e.stopPropagation();
    ...
    const handleVisibilityChange = () => {
      ...
      if (document.hidden || document.visibilityState === 'hidden') {
        ...
        if (timeSinceLastChange < 3000) {
          ...
          // Only escalate to blocking on non-mobile platforms
          if (!isMobile && visibilityChangeCount >= 2) {
            setScreenshotBlocked(true);
          }
        } else {
